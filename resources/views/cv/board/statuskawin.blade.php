...
<table cellspacing="0" border="0">
	...
	<tr>
		...
		<td style="background-color : #8f8e8e ;border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 2px solid #000000" colspan=7 align="left" valign=middle ><b><font face="Arial" size=4 color="#000000">Status Kawin</font></b></td>
        </tr>
    ...
    <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 2px solid #000000; border-right: 1px solid #000000" align="left" valign=middle sdval="1" sdnum="1033;"><font face="Arial" size=15 color="#000000">{{$num++}}</font></td>
		<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=middle><font face="Arial" size=4 color="#000000">{{$sk->id}}</font></td>
		<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 2px solid #000000" colspan=7 align="left" valign=middle><font face="Arial" size=4 color="#000000">{{$sk->nama}}</font></td>
        </tr>
    @endforeach
