              ...
              @foreach($kelas as $data)  
                ...
                @endif
                      ...
                      @if($trans_kelas->contains('id_kelas', $data->id))
                        <input type="checkbox" onclick='saveClick();' checked name="kelas" value="{{$data->id}}">     
                      @else
                        <input type="checkbox" onclick='saveClick();' name="kelas" value="{{$data->id}}">   
                      @endif
