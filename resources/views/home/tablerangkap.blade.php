    ...
    $(document).ready(function(){
        ...
        .on('xhr.dt', function ( e, settings, json, xhr ) {
            ...
            columns: [
              ...
              { data: 'pejabat', name: 'pejabat', searchable: false, visible: false},
            ...
            drawCallback: function( settings ) {
              ...
              api.column(1, {page:'current'} ).data().each( function ( group, i ) {
                  if ( last !== group ) {
                      $(rows).eq( i ).before(
                          '<tr><td colspan="9" style="BACKGROUND-COLOR:rgb(180, 218, 252);font-weight:700;">'+no+'. '+group+'</td></tr>'
                      );
                      last = group;
                      no++;
                  }
