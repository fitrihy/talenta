...
<div class="kt-portlet kt-portlet--mobile">
    ...
    <div class="kt-portlet__body form">
    	<form class="kt-form kt-form--label-right" method="post" id="form-datapokok" role="form" enctype="multipart/form-data" action="/administrasi/anak/{{ $suratkeputusan->id }}">
			@csrf
			{{ method_field('PUT') }}
			<div class="kt-portlet__body">
				...
				<div class="form-group row">
                    <div class="col-lg-6">
                        ...
                        <select class="form-control kt-select2" required="required" id="id_anak" name="id_anak">
                            ...
                            <option value="{{ $anak->id }}" <?=old('id_perusahaan') == $anak->id || $suratkeputusan->id_perusahaan == $anak->id? 'selected="selected"':''?>>{{ $anak->nama_lengkap }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <input type="text" id="tgl_sk" name="tgl_sk" required="required" class="form-control kt-shape-bg-color-1 input-sm date-picker" value="{{ $tanggal_sk }}" />
                        <span class="form-text text-muted">Masukan Tanggal SK</span>
                    </div>
                    <div class="col-lg-4">
                        <label>Tanggal Serah Terima SK</label>
                        <input type="text" id="tanggal_serah_terima" name="tanggal_serah_terima" required="required" class="form-control kt-shape-bg-color-1 input-sm date-picker" value="{{ $tanggal_serah_terima }}" />
