<form class="kt-form kt-form--label-right" method="POST" id="form-independen">
	@csrf
...
<script type="text/javascript" src="{{asset('js/administrasi/bumn/formindependen.js')}}"></script>