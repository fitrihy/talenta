...
function setFormValidate(){
    $('#form-user').validate({
        ...
        messages: {
                   kategori_user_id: {
                       required: "Kategori user wajib dipilih"
                   },
                   name: {
...
function onReadEvent(){
  ...
  $('#kategori_user_id').change(function(){
    ...
    switch(parseInt($(this).find(':selected').data('inputan'))){
      ...
      case 1 : $('.divasalinstansi').css('display', 'none');
               ...
               $('.divassessment').css('display', 'none');
      ...
      //Pejabat
      case 3 : $('.divbumn').removeAttr('style');
               $('.divasalinstansi').css('display', 'none');
               $('.divassessment').css('display', 'none');
      ...
      //Lembaga Assessment
      case 4 : $('.divassessment').removeAttr('style');
               $('.divasalinstansi').css('display', 'none');;
               $('.divbumn').css('display', 'none');

               $('#id_assessment').rules('add', {
                required: true,
                messages: {
                  required: "Lembaga Assessment wajib dipilih"
                }
               });
  ...
  if(actionform === 'update'){
    ...
    let asseshidden = jQuery.parseJSON($('#asseshidden').val());
        ...
        if(asseshidden != ''){
          $('#id_assessment').select2("trigger", "select", {
            data: {
              'id':asseshidden.id,
              'text':asseshidden.nama
            }              
          });
        } 
...
function setAssessment(){
    $('#id_assessment').select2({
        width:'100%',
        allowClear: true,
        placeholder: '[ - Pilih Lembaga Assessment - ]',
        ajax: {
            url: urlfetchassessment,
            dataType: 'json',
            data: function(params) {
                return {
                    q: params.term, 
